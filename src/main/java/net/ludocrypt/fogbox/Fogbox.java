...
public class Fogbox implements ClientModInitializer {
	...
	public static final boolean RENDERING_MOD = (FabricLoader.getInstance().isModLoaded("irisshaders") || FabricLoader.getInstance().isModLoaded("optifine") || FabricLoader.getInstance().isModLoaded("optifabric") || FabricLoader.getInstance().isModLoaded("canvas"));
